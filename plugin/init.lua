...
local function get_require_path()
  local path = "httpssCssZssZsgithubsDscomsZsItsThatOneJack-DevsZsbarsDswezterm"
  local path_trailing_slash = "httpssCssZssZsgithubsDscomsZsItsThatOneJack-DevsZsbarsDsweztermsZs"
  ...
  local callbacks = {
    {
      name = "spotify",
      func = function()
        return spotify.get_currently_playing(options.modules.spotify.max_width, options.modules.spotify.throttle, options.modules.spotify.command, options.modules.spotify.gubs)
      end,
    },
    {
      name = "username",
